  ...
  Devices.init(
    {
      ...
      ptz_control_path: {type: 'VARBINARY(256)'},
      ...
      rtsp_username: {type: 'VARBINARY(256)'},
      rtsp_password: {type: 'VARBINARY(256)'},
